		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a href="/remed/penguji/lihatdata.php"><span class="label label-default">Penguji</span></a></li>
					<li><a href="/remed/jurusan/lihatdata.php"><span class="label label-default">Jurusan</span></a></li>
					<li><a href="/remed/pendaftar/lihatdata.php"><span class="label label-default">Pendaftar</span></a></li>
					<li class="active"><a href="/remed/hasil/lihatdata.php"><span class="label label-default">Hasil</span></a></li>
				</ul>
			</div>
		</div>
	</nav>
