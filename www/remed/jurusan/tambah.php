...
<body>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a href="/remed/penguji/lihatdata.php">Penguji</a></li>
					<li class="active"><a href="/remed/jurusan/lihatdata.php">Jurusan</a></li>
	...
	<div class="container">
		<div class="panel panel-primary">
			<div class="panel-heading"><center>Tambah Data Jurusan</center></div>
			<div class="panel-body">
				<form action="simpan.php" method="post">
					...
					<p>
						...
						<input type="text" name="nl" class="form-control" required>
					</p>
					<p>
	...
	<br>
	<center><a href="lihatdata.php" class="btn btn-primary">&lt; Table Jurusan</a></center>
