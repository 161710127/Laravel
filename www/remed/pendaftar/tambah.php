...
<body>
				...
				<div class="panel-body">
					<form action="simpan.php" method="post">
						...
						<p>
							...
							<div class="radio">
								<label>
									<p><input type="radio" name="jk" value="Laki - laki" required> Laki - laki</p>
									<p><input type="radio" name="jk" value="Perempuan" required> Perempuan</p>
								</label>
							</div>
						</p>
						<p>
	...
	<br>
	<center><a href="lihatdata.php" class="btn btn-primary">&lt; Table Pendaftar</a></center>
