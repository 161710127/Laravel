...
<body>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				...
				<ul class="nav navbar-nav navbar-right">
					<li><a href="/UTS/kepsek/lihatdata.php"><span class="label label-info">Kepala Sekolah</span></a></li>
					<li><a href="/UTS/penguji/lihatdata.php"><span class="label label-primary">Penguji</span></a></li>
					<li><a href="/UTS/jurusan/lihatdata.php"><span class="label label-warning">Jurusan</span></a></li>
					<li><a href="/UTS/pendaftar/lihatdata.php"><span class="label label-success">Pendaftar</span></a></li>
					<li class="active"><a href="/UTS/hasil/lihatdata.php"><span class="label label-default">Hasil</span></a></li>
				</ul>
			</div>
		</div>
	</nav>
	<h1 align="center">Data Hasil</h1>
	...
	<center><a class="btn btn-success" href="tambah.php">&plus; Tambah Data</a></center>
</body>
</html>