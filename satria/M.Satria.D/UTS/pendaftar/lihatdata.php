		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				...
				<ul class="nav navbar-nav navbar-right">
					<li><a href="/UTS/kepsek/lihatdata.php"><span class="label label-danger">Kepala Sekolah</span></a></li>
					<li><a href="/UTS/penguji/lihatdata.php"><span class="label label-success">Penguji</span></a></li>
					<li><a href="/UTS/jurusan/lihatdata.php"><span class="label label-warning">Jurusan</span></a></li>
					<li class="active"><a href="/UTS/pendaftar/lihatdata.php"><span class="label label-primary">Pendaftar</span></a></li>
